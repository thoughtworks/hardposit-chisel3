...
class Eval_PositINtoPN(totalBits: Int, es: Int, intWidth: Int) extends Module {
  ...
  val i2p = Module(new ItoPConverter(totalBits, es, intWidth))
...
class Eval_PositUINtoPN(totalBits: Int, es: Int, intWidth: Int) extends Module {
