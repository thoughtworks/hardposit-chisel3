// qsys_top_altera_arria10_hps_181_2xyroxa.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_arria10_hps_181_2xyroxa #(
	...
	qsys_top_altera_arria10_interface_generator_140_hgum2rq fpga_interfaces (
		.h2f_rst_n          (h2f_rst_n),          //  output,     width = 1,           h2f_reset.reset_n
		.f2h_cold_rst_req_n (f2h_cold_rst_req_n), //   input,     width = 1,  f2h_cold_reset_req.reset_n
		.f2h_dbg_rst_req_n  (f2h_dbg_rst_req_n),  //   input,     width = 1, f2h_debug_reset_req.reset_n
		.f2h_warm_rst_req_n (f2h_warm_rst_req_n), //   input,     width = 1,  f2h_warm_reset_req.reset_n
		.f2h_stm_hwevents   (f2h_stm_hwevents),   //   input,    width = 28,   f2h_stm_hw_events.stm_hwevents
	...
	qsys_top_altera_arria10_hps_io_181_fk2aczy hps_io (
