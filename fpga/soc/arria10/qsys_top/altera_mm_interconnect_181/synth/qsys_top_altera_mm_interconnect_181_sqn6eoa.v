// qsys_top_altera_mm_interconnect_181_sqn6eoa.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_181_sqn6eoa (
	...
	wire    [2:0] router_src_channel;                                         // router:src_channel -> a10_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire    [2:0] a10_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel;       // a10_hps_h2f_lw_axi_master_wr_limiter:rsp_src_channel -> a10_hps_h2f_lw_axi_master_agent:write_rp_channel
	...
	wire    [2:0] router_001_src_channel;                                     // router_001:src_channel -> a10_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire    [2:0] a10_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel;       // a10_hps_h2f_lw_axi_master_rd_limiter:rsp_src_channel -> a10_hps_h2f_lw_axi_master_agent:read_rp_channel
	...
	wire    [2:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> num1_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> num2_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] cmd_mux_002_src_channel;                                    // cmd_mux_002:src_channel -> result_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] a10_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;       // a10_hps_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	...
	wire    [2:0] limiter_pipeline_001_source0_channel;                       // limiter_pipeline_001:out_channel -> a10_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [2:0] a10_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;       // a10_hps_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> limiter_pipeline_002:in_channel
	...
	wire    [2:0] limiter_pipeline_003_source0_channel;                       // limiter_pipeline_003:out_channel -> a10_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [2:0] num1_s1_burst_adapter_source0_channel;                      // num1_s1_burst_adapter:source0_channel -> agent_pipeline:in_channel
	...
	wire    [2:0] agent_pipeline_source0_channel;                             // agent_pipeline:out_channel -> num1_s1_agent:cp_channel
	...
	wire    [2:0] num2_s1_burst_adapter_source0_channel;                      // num2_s1_burst_adapter:source0_channel -> agent_pipeline_002:in_channel
	...
	wire    [2:0] agent_pipeline_002_source0_channel;                         // agent_pipeline_002:out_channel -> num2_s1_agent:cp_channel
	...
	wire    [2:0] result_s1_burst_adapter_source0_channel;                    // result_s1_burst_adapter:source0_channel -> agent_pipeline_004:in_channel
	...
	wire    [2:0] agent_pipeline_004_source0_channel;                         // agent_pipeline_004:out_channel -> result_s1_agent:cp_channel
	...
	wire    [2:0] mux_pipeline_002_source0_channel;                           // mux_pipeline_002:out_channel -> cmd_mux_001:sink0_channel
	...
	wire    [2:0] mux_pipeline_003_source0_channel;                           // mux_pipeline_003:out_channel -> cmd_mux_001:sink1_channel
	...
	wire    [2:0] cmd_demux_src2_channel;                                     // cmd_demux:src2_channel -> mux_pipeline_004:in_channel
	...
	wire    [2:0] mux_pipeline_004_source0_channel;                           // mux_pipeline_004:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [2:0] cmd_demux_001_src2_channel;                                 // cmd_demux_001:src2_channel -> mux_pipeline_005:in_channel
	...
	wire    [2:0] mux_pipeline_005_source0_channel;                           // mux_pipeline_005:out_channel -> cmd_mux_002:sink1_channel
	...
	wire  [118:0] rsp_demux_src0_data;                                        // rsp_demux:src0_data -> mux_pipeline_006:in_data
	...
	wire  [118:0] mux_pipeline_006_source0_data;                              // mux_pipeline_006:out_data -> rsp_mux:sink0_data
	...
	wire  [118:0] rsp_demux_001_src0_data;                                    // rsp_demux_001:src0_data -> mux_pipeline_007:in_data
	...
	wire  [118:0] mux_pipeline_007_source0_data;                              // mux_pipeline_007:out_data -> rsp_mux:sink1_data
	...
	wire  [118:0] rsp_demux_002_src0_data;                                    // rsp_demux_002:src0_data -> mux_pipeline_008:in_data
	wire          rsp_demux_002_src0_ready;                                   // mux_pipeline_008:in_ready -> rsp_demux_002:src0_ready
	wire    [2:0] rsp_demux_002_src0_channel;                                 // rsp_demux_002:src0_channel -> mux_pipeline_008:in_channel
	...
	wire  [118:0] mux_pipeline_008_source0_data;                              // mux_pipeline_008:out_data -> rsp_mux:sink2_data
	wire          mux_pipeline_008_source0_ready;                             // rsp_mux:sink2_ready -> mux_pipeline_008:out_ready
	wire    [2:0] mux_pipeline_008_source0_channel;                           // mux_pipeline_008:out_channel -> rsp_mux:sink2_channel
	...
	wire  [118:0] rsp_demux_src1_data;                                        // rsp_demux:src1_data -> mux_pipeline_009:in_data
	wire          rsp_demux_src1_ready;                                       // mux_pipeline_009:in_ready -> rsp_demux:src1_ready
	wire    [2:0] rsp_demux_src1_channel;                                     // rsp_demux:src1_channel -> mux_pipeline_009:in_channel
	...
	wire  [118:0] mux_pipeline_009_source0_data;                              // mux_pipeline_009:out_data -> rsp_mux_001:sink0_data
	wire          mux_pipeline_009_source0_ready;                             // rsp_mux_001:sink0_ready -> mux_pipeline_009:out_ready
	wire    [2:0] mux_pipeline_009_source0_channel;                           // mux_pipeline_009:out_channel -> rsp_mux_001:sink0_channel
	...
	wire          rsp_demux_001_src1_valid;                                   // rsp_demux_001:src1_valid -> mux_pipeline_010:in_valid
	wire  [118:0] rsp_demux_001_src1_data;                                    // rsp_demux_001:src1_data -> mux_pipeline_010:in_data
	wire          rsp_demux_001_src1_ready;                                   // mux_pipeline_010:in_ready -> rsp_demux_001:src1_ready
	wire    [2:0] rsp_demux_001_src1_channel;                                 // rsp_demux_001:src1_channel -> mux_pipeline_010:in_channel
	wire          rsp_demux_001_src1_startofpacket;                           // rsp_demux_001:src1_startofpacket -> mux_pipeline_010:in_startofpacket
	wire          rsp_demux_001_src1_endofpacket;                             // rsp_demux_001:src1_endofpacket -> mux_pipeline_010:in_endofpacket
	wire          mux_pipeline_010_source0_valid;                             // mux_pipeline_010:out_valid -> rsp_mux_001:sink1_valid
	wire  [118:0] mux_pipeline_010_source0_data;                              // mux_pipeline_010:out_data -> rsp_mux_001:sink1_data
	wire          mux_pipeline_010_source0_ready;                             // rsp_mux_001:sink1_ready -> mux_pipeline_010:out_ready
	wire    [2:0] mux_pipeline_010_source0_channel;                           // mux_pipeline_010:out_channel -> rsp_mux_001:sink1_channel
	...
	wire          rsp_demux_002_src1_valid;                                   // rsp_demux_002:src1_valid -> mux_pipeline_011:in_valid
	wire  [118:0] rsp_demux_002_src1_data;                                    // rsp_demux_002:src1_data -> mux_pipeline_011:in_data
	wire          rsp_demux_002_src1_ready;                                   // mux_pipeline_011:in_ready -> rsp_demux_002:src1_ready
	wire    [2:0] rsp_demux_002_src1_channel;                                 // rsp_demux_002:src1_channel -> mux_pipeline_011:in_channel
	wire          rsp_demux_002_src1_startofpacket;                           // rsp_demux_002:src1_startofpacket -> mux_pipeline_011:in_startofpacket
	wire          rsp_demux_002_src1_endofpacket;                             // rsp_demux_002:src1_endofpacket -> mux_pipeline_011:in_endofpacket
	wire          mux_pipeline_011_source0_valid;                             // mux_pipeline_011:out_valid -> rsp_mux_001:sink2_valid
	wire  [118:0] mux_pipeline_011_source0_data;                              // mux_pipeline_011:out_data -> rsp_mux_001:sink2_data
	wire          mux_pipeline_011_source0_ready;                             // rsp_mux_001:sink2_ready -> mux_pipeline_011:out_ready
	wire    [2:0] mux_pipeline_011_source0_channel;                           // mux_pipeline_011:out_channel -> rsp_mux_001:sink2_channel
	...
	qsys_top_altera_merlin_axi_master_ni_181_dp4ifgy #(
		...
		.write_rp_channel       (a10_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel),       //   input,    width = 3,                 .channel
		...
		.read_rp_channel        (a10_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel),       //   input,    width = 3,                 .channel
	...
	qsys_top_altera_merlin_router_181_7nqkolq router (
	...
	qsys_top_altera_merlin_router_181_7nqkolq router_001 (
	...
	qsys_top_altera_merlin_router_181_fqgo25q router_002 (
	...
	qsys_top_altera_merlin_router_181_fqgo25q router_003 (
	...
	qsys_top_altera_merlin_router_181_fqgo25q router_004 (
	...
	qsys_top_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_channel        (a10_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel),       //  output,    width = 3,          .channel
		...
		.rsp_src_channel        (a10_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_channel        (a10_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel),       //  output,    width = 3,          .channel
		...
		.rsp_src_channel        (a10_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_181_efhh5ua #(
		...
		.source0_channel       (num1_s1_burst_adapter_source0_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_181_efhh5ua #(
		...
		.source0_channel       (num2_s1_burst_adapter_source0_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_181_efhh5ua #(
		...
		.source0_channel       (result_s1_burst_adapter_source0_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_181_ibonxii cmd_demux (
		.clk                (clock_bridge_0_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset              (a10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_181_ibonxii cmd_demux_001 (
		.clk                (clock_bridge_0_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset              (a10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_181_63w2npy cmd_mux (
		.clk                 (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_181_63w2npy cmd_mux_001 (
		.clk                 (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_channel       (mux_pipeline_003_source0_channel),       //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_multiplexer_181_63w2npy cmd_mux_002 (
		.clk                 (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_004_source0_channel),       //   input,    width = 3,          .channel
		...
		.sink1_channel       (mux_pipeline_005_source0_channel),       //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_181_dbzr4fa rsp_demux (
		.clk                (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset              (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_181_dbzr4fa rsp_demux_001 (
		.clk                (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset              (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_181_dbzr4fa rsp_demux_002 (
		.clk                (clock_bridge_0_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset              (num1_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_181_ua4lkca rsp_mux (
		.clk                 (clock_bridge_0_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset               (a10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_channel       (mux_pipeline_008_source0_channel),                     //   input,    width = 3,          .channel
		.sink2_data          (mux_pipeline_008_source0_data),                        //   input,  width = 119,          .data
	...
	qsys_top_altera_merlin_multiplexer_181_ua4lkca rsp_mux_001 (
		.clk                 (clock_bridge_0_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset               (a10_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_009_source0_channel),                     //   input,    width = 3,          .channel
		.sink0_data          (mux_pipeline_009_source0_data),                        //   input,  width = 119,          .data
		...
		.sink1_channel       (mux_pipeline_010_source0_channel),                     //   input,    width = 3,          .channel
		.sink1_data          (mux_pipeline_010_source0_data),                        //   input,  width = 119,          .data
		...
		.sink2_channel       (mux_pipeline_011_source0_channel),                     //   input,    width = 3,          .channel
		.sink2_data          (mux_pipeline_011_source0_data),                        //   input,  width = 119,          .data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (a10_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel),       //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (a10_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel),       //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (num1_s1_burst_adapter_source0_channel),       //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (num2_s1_burst_adapter_source0_channel),       //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (result_s1_burst_adapter_source0_channel),       //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (cmd_demux_001_src2_channel),             //   input,    width = 3,          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_channel        (rsp_demux_002_src1_channel),                           //   input,    width = 3,          .channel
