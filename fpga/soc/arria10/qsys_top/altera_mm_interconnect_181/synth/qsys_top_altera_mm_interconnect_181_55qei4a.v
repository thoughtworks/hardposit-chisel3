// qsys_top_altera_mm_interconnect_181_55qei4a.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_181_55qei4a (
	...
	wire   [17:0] onchip_memory2_0_s1_agent_rdata_fifo_src_data;              // onchip_memory2_0_s1_agent:rdata_fifo_src_data -> onchip_memory2_0_s1_agent_rdata_fifo:in_data
	...
	wire   [17:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;              // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> onchip_memory2_0_s1_agent:rdata_fifo_sink_data
	...
	wire  [103:0] onchip_memory2_1_s1_agent_rf_source_data;                   // onchip_memory2_1_s1_agent:rf_source_data -> onchip_memory2_1_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] onchip_memory2_1_s1_agent_rsp_fifo_out_data;                // onchip_memory2_1_s1_agent_rsp_fifo:out_data -> onchip_memory2_1_s1_agent:rf_sink_data
	...
	wire   [17:0] onchip_memory2_1_s1_agent_rdata_fifo_src_data;              // onchip_memory2_1_s1_agent:rdata_fifo_src_data -> onchip_memory2_1_s1_agent_rdata_fifo:in_data
	...
	wire   [17:0] onchip_memory2_1_s1_agent_rdata_fifo_out_data;              // onchip_memory2_1_s1_agent_rdata_fifo:out_data -> onchip_memory2_1_s1_agent:rdata_fifo_sink_data
	...
	wire  [102:0] router_005_src_data;                                        // router_005:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [102:0] router_009_src_data;                                        // router_009:src_data -> onchip_memory2_1_s1_rsp_width_adapter:in_data
	...
	wire  [102:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;             // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [102:0] onchip_memory2_1_s1_cmd_width_adapter_src_data;             // onchip_memory2_1_s1_cmd_width_adapter:out_data -> onchip_memory2_1_s1_burst_adapter:sink0_data
	...
	wire  [102:0] onchip_memory2_0_s1_burst_adapter_source0_data;             // onchip_memory2_0_s1_burst_adapter:source0_data -> agent_pipeline_006:in_data
	...
	wire  [102:0] agent_pipeline_006_source0_data;                            // agent_pipeline_006:out_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [102:0] onchip_memory2_0_s1_agent_rp_data;                          // onchip_memory2_0_s1_agent:rp_data -> agent_pipeline_007:in_data
	...
	wire  [102:0] agent_pipeline_007_source0_data;                            // agent_pipeline_007:out_data -> router_005:sink_data
	...
	wire  [102:0] onchip_memory2_1_s1_burst_adapter_source0_data;             // onchip_memory2_1_s1_burst_adapter:source0_data -> agent_pipeline_014:in_data
	...
	wire  [102:0] agent_pipeline_014_source0_data;                            // agent_pipeline_014:out_data -> onchip_memory2_1_s1_agent:cp_data
	...
	wire  [102:0] onchip_memory2_1_s1_agent_rp_data;                          // onchip_memory2_1_s1_agent:rp_data -> agent_pipeline_015:in_data
	...
	wire  [102:0] agent_pipeline_015_source0_data;                            // agent_pipeline_015:out_data -> router_009:sink_data
	...
	qsys_top_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_burstcount         (onchip_memory2_0_s1_agent_m0_burstcount),    //   input,   width = 2,                         .burstcount
		...
		.uav_byteenable         (onchip_memory2_0_s1_agent_m0_byteenable),    //   input,   width = 2,                         .byteenable
		.uav_readdata           (onchip_memory2_0_s1_agent_m0_readdata),      //  output,  width = 16,                         .readdata
		.uav_writedata          (onchip_memory2_0_s1_agent_m0_writedata),     //   input,  width = 16,                         .writedata
		...
		.av_readdata            (onchip_memory2_0_s1_readdata),               //   input,  width = 16,                         .readdata
		.av_writedata           (onchip_memory2_0_s1_writedata),              //  output,  width = 16,                         .writedata
		.av_byteenable          (onchip_memory2_0_s1_byteenable),             //  output,   width = 2,                         .byteenable
	...
	qsys_top_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_burstcount         (onchip_memory2_1_s1_agent_m0_burstcount),    //   input,   width = 2,                         .burstcount
		...
		.uav_byteenable         (onchip_memory2_1_s1_agent_m0_byteenable),    //   input,   width = 2,                         .byteenable
		.uav_readdata           (onchip_memory2_1_s1_agent_m0_readdata),      //  output,  width = 16,                         .readdata
		.uav_writedata          (onchip_memory2_1_s1_agent_m0_writedata),     //   input,  width = 16,                         .writedata
		...
		.av_address             (onchip_memory2_1_s1_address),                //  output,  width = 11,      avalon_anti_slave_0.address
		.av_write               (onchip_memory2_1_s1_write),                  //  output,   width = 1,                         .write
		.av_readdata            (onchip_memory2_1_s1_readdata),               //   input,  width = 16,                         .readdata
		.av_writedata           (onchip_memory2_1_s1_writedata),              //  output,  width = 16,                         .writedata
		.av_byteenable          (onchip_memory2_1_s1_byteenable),             //  output,   width = 2,                         .byteenable
	...
	qsys_top_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.m0_burstcount           (onchip_memory2_0_s1_agent_m0_burstcount),              //  output,    width = 2,                .burstcount
		.m0_byteenable           (onchip_memory2_0_s1_agent_m0_byteenable),              //  output,    width = 2,                .byteenable
		...
		.m0_readdata             (onchip_memory2_0_s1_agent_m0_readdata),                //   input,   width = 16,                .readdata
		...
		.m0_writedata            (onchip_memory2_0_s1_agent_m0_writedata),               //  output,   width = 16,                .writedata
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (agent_pipeline_006_source0_data),                      //   input,  width = 103,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),             //  output,  width = 104,                .data
		...
		.rdata_fifo_sink_data    (onchip_memory2_0_s1_agent_rdata_fifo_out_data),        //   input,   width = 18,                .data
		...
		.rdata_fifo_src_data     (onchip_memory2_0_s1_agent_rdata_fifo_src_data),        //  output,   width = 18,                .data
		.m0_response             (2'b00),                                                // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                 // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                  // (terminated),                               
	);
	...
	qsys_top_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (iopll_0_outclk0_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (num1_reset_reset_bridge_in_reset_reset),               //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	qsys_top_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (iopll_0_outclk0_clk),                            //   input,   width = 1,       clk.clk
		.reset             (num1_reset_reset_bridge_in_reset_reset),         //   input,   width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rdata_fifo_src_data),  //   input,  width = 18,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rdata_fifo_out_data),  //  output,  width = 18,       out.data
	...
	qsys_top_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.m0_burstcount           (onchip_memory2_1_s1_agent_m0_burstcount),              //  output,    width = 2,                .burstcount
		.m0_byteenable           (onchip_memory2_1_s1_agent_m0_byteenable),              //  output,    width = 2,                .byteenable
		...
		.m0_readdata             (onchip_memory2_1_s1_agent_m0_readdata),                //   input,   width = 16,                .readdata
		...
		.m0_writedata            (onchip_memory2_1_s1_agent_m0_writedata),               //  output,   width = 16,                .writedata
		...
		.rp_data                 (onchip_memory2_1_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (agent_pipeline_014_source0_data),                      //   input,  width = 103,                .data
		...
		.rf_sink_data            (onchip_memory2_1_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (onchip_memory2_1_s1_agent_rf_source_data),             //  output,  width = 104,                .data
		...
		.rdata_fifo_sink_data    (onchip_memory2_1_s1_agent_rdata_fifo_out_data),        //   input,   width = 18,                .data
		...
		.rdata_fifo_src_data     (onchip_memory2_1_s1_agent_rdata_fifo_src_data),        //  output,   width = 18,                .data
		.m0_response             (2'b00),                                                // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                 // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                  // (terminated),                               
	);
	...
	qsys_top_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (iopll_0_outclk0_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (num1_reset_reset_bridge_in_reset_reset),               //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_1_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (onchip_memory2_1_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	qsys_top_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (iopll_0_outclk0_clk),                            //   input,   width = 1,       clk.clk
		.reset             (num1_reset_reset_bridge_in_reset_reset),         //   input,   width = 1, clk_reset.reset
		.in_data           (onchip_memory2_1_s1_agent_rdata_fifo_src_data),  //   input,  width = 18,        in.data
		...
		.out_data          (onchip_memory2_1_s1_agent_rdata_fifo_out_data),  //  output,  width = 18,       out.data
	...
	qsys_top_altera_merlin_router_181_r46v5yq router_005 (
		...
		.sink_data          (agent_pipeline_007_source0_data),          //   input,  width = 103,          .data
		...
		.src_data           (router_005_src_data),                      //  output,  width = 103,          .data
	...
	qsys_top_altera_merlin_router_181_r46v5yq router_009 (
		...
		.sink_data          (agent_pipeline_015_source0_data),          //   input,  width = 103,          .data
		...
		.src_data           (router_009_src_data),                      //  output,  width = 103,          .data
	...
	qsys_top_altera_merlin_burst_adapter_181_s7lrvgq #(
		.PKT_ADDR_H                (38),
		.PKT_ADDR_L                (18),
		.PKT_BEGIN_BURST           (70),
		.PKT_BYTE_CNT_H            (51),
		...
		.sink0_data            (onchip_memory2_0_s1_cmd_width_adapter_src_data),          //   input,  width = 103,          .data
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),          //  output,  width = 103,          .data
	...
	qsys_top_altera_merlin_burst_adapter_181_s7lrvgq #(
		...
		.sink0_data            (onchip_memory2_1_s1_cmd_width_adapter_src_data),          //   input,  width = 103,          .data
		...
		.source0_data          (onchip_memory2_1_s1_burst_adapter_source0_data),          //  output,  width = 103,          .data
	...
	qsys_top_altera_merlin_width_adapter_181_erek4wa #(
		.IN_PKT_ADDR_H                 (38),
		.IN_PKT_ADDR_L                 (18),
		.IN_PKT_DATA_H                 (15),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_005_src_data),                                     //   input,  width = 103,          .data
	...
	qsys_top_altera_merlin_width_adapter_181_erek4wa #(
		...
		.in_data              (router_009_src_data),                                     //   input,  width = 103,          .data
	...
	qsys_top_altera_merlin_width_adapter_181_guxmpsy #(
		.IN_PKT_ADDR_H                 (56),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.out_data             (onchip_memory2_0_s1_cmd_width_adapter_src_data),          //  output,  width = 103,          .data
	...
	qsys_top_altera_merlin_width_adapter_181_guxmpsy #(
		...
		.out_data             (onchip_memory2_1_s1_cmd_width_adapter_src_data),          //  output,  width = 103,          .data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (onchip_memory2_0_s1_burst_adapter_source0_data),          //   input,  width = 103,          .data
		...
		.out_data          (agent_pipeline_006_source0_data),                         //  output,  width = 103,          .data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (onchip_memory2_0_s1_agent_rp_data),          //   input,  width = 103,          .data
		...
		.out_data          (agent_pipeline_007_source0_data),            //  output,  width = 103,          .data
		.in_empty          (1'b0),                                       // (terminated),                         
		.out_empty         (),                                           // (terminated),                         
		.out_error         (),                                           // (terminated),                         
		.in_error          (1'b0),                                       // (terminated),                         
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (onchip_memory2_1_s1_burst_adapter_source0_data),          //   input,  width = 103,          .data
		...
		.out_data          (agent_pipeline_014_source0_data),                         //  output,  width = 103,          .data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (onchip_memory2_1_s1_agent_rp_data),          //   input,  width = 103,          .data
		...
		.out_data          (agent_pipeline_015_source0_data),            //  output,  width = 103,          .data
		.in_empty          (1'b0),                                       // (terminated),                         
		.out_empty         (),                                           // (terminated),                         
		.out_error         (),                                           // (terminated),                         
		.in_error          (1'b0),                                       // (terminated),                         
