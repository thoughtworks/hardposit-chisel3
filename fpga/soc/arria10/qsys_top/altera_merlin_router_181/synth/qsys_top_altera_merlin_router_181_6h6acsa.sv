...
module qsys_top_altera_merlin_router_181_6h6acsa_default_decode
  #(
...
module qsys_top_altera_merlin_router_181_6h6acsa
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    qsys_top_altera_merlin_router_181_6h6acsa_default_decode the_default_decode(
    ...
    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 15'h3000  && read_transaction  ) begin
