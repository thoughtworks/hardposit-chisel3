...
module qsys_top_altera_merlin_router_181_lyv6hfy_default_decode
  #(
...
module qsys_top_altera_merlin_router_181_lyv6hfy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    qsys_top_altera_merlin_router_181_lyv6hfy_default_decode the_default_decode(
    ...
    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 15'h3000  && read_transaction  ) begin
