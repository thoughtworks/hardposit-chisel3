...
module qsys_top_altera_merlin_router_181_ueryrxi_default_decode
  #(
...
module qsys_top_altera_merlin_router_181_ueryrxi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD7 = log2ceil(64'h9000 - 64'h8000); 
    // -------------------------------------------------------
    ...
    qsys_top_altera_merlin_router_181_ueryrxi_default_decode the_default_decode(
    ...
    // ( 0x2000 .. 0x2010 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 16'h2000   ) begin
            src_channel = 8'b00000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 16'h3000  && read_transaction  ) begin
    ...
    // ( 0x6000 .. 0x6010 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 16'h6000  && read_transaction  ) begin
            src_channel = 8'b00100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x7000 .. 0x7010 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 16'h7000   ) begin
